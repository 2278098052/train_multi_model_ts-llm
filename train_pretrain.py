...
if __name__ == '__main__':
    ...
    parser.add_argument('--per_device_train_batch_size', type=int, default=256, help='batch size per device during training')
    parser.add_argument('--per_device_eval_batch_size', type=int, default=256, help='batch size for evaluation')
    ...
    #logging settings
    parser.add_argument('--output_dir', type=str, default='save/pretrain_ts_orin', help='output directory')
    ...
    ts_path = 'dataset/dataset_processing/test_data_Normalizd.h5'
    qa_path = 'dataset/dataset_processing/output_qa_pairs_test.json'
    ...
    dataset = TsQaDataset(ts_path, qa_path, 
                          tokenizer, processor, tlmconfig,pretrain=True)
    # data_collator = DataCollator(tokenizer)
    output_dir = 'save/pretrain_ts' 
    # print(os.environ)

    wandb.init(project="TSLLM-TsEncoder", name="pandalin")
